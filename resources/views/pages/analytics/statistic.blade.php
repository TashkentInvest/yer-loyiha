        ...
        <div class="page-header">
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="assets/new/dashboard/index.html">Home</a></li>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card statistics-card-1">
                    ...
                    <div class="card-body">
                        <img src="{{asset('assets/new/assets/images/widget/img-status-1.svg')}}" alt="img"
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card statistics-card-1">
                    ...
                    <div class="card-body">
                        <img src="{{asset('assets/new/assets/images/widget/img-status-2.svg')}}" alt="img" class="img-fluid img-bg">
                        <div class="d-flex align-items-center">
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="card statistics-card-1">
                    ...
                    <div class="card-body">
                        <img src="{{asset('assets/new/assets/images/widget/img-status-3.svg')}}" alt="img" class="img-fluid img-bg">
                        <div class="d-flex align-items-center">
                ...
                <div class="card overflow-hidden">
                    <div class="card-body bg-light-primary">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <img src="{{asset('assets/new/assets/images/widget/img-visitor.png')}}" alt="img" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="mb-0"><i class="ph-duotone ph-circle text-warning me-2"></i> Parcel in the way
                            </p>
                        ...
                        <p class="mb-0">
                            <span class="text-success"><i class="ph-duotone ph-caret-up f-20 align-bottom"></i>
                                +15%</span> last month
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-xl-8">
                <div class="card bg-brand-color-3 earning-card statistics-card-1">
                    <div class="card-body overflow-hidden">
                        <img src="{{asset('assets/new/assets/images/widget/img-earning-bg.svg')}}" alt="img"
                            class="img-fluid img-bg h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0">
                                <img src="{{asset('assets/new/assets/images/favicon.svg')}}" alt="img" class="img-fluid">
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 me-2">
                                <div class="user-group">
                                    <img src="{{asset('assets/new/assets/images/user/avatar-6.jpg')}}" alt="user-image" class="avtar">
                                    <img src="{{asset('assets/new/assets/images/user/avatar-6.jpg')}}" alt="user-image" class="avtar">
                                    <img src="{{asset('assets/new/assets/images/user/avatar-7.jpg')}}" alt="user-image" class="avtar">
                                    <img src="{{asset('assets/new/assets/images/user/avatar-8.jpg')}}" alt="user-image" class="avtar">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-1">
                            <div class="col-6">
                                <p class="mb-0"><i class="ph-duotone ph-circle text-success f-12"></i> React native
                                </p>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <p class="mb-0"><i class="ph-duotone ph-circle text-warning f-12"></i> Bootstrap 5
                                </p>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="badge bg-danger ms-2"><i
                                    class="ph-duotone ph-arrow-down me-1 align-middle"></i> 2.6%</span>
                        </div>
                    </div>
                </div>
            </div>
