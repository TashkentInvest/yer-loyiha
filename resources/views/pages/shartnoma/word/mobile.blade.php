            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td>{{$order->branch->client->last_name}} {{$order->branch->client->first_name}} {{$order->branch->client->father_name}}</td>
                    </tr>
                    @if ($client->mijoz_turi == 'fizik')
                        ...
                        <tr>
                            ...
                            <td>{{ $order->branch->client->substreet && 
                                $order->branch->client->substreet->district && 
                                $order->branch->client->substreet->district->region
                                    ? $order->branch->client->substreet->district->region->name_uz
                                    : 'N/A' }}
                                {{ $order->branch->client->substreet && 
                                $order->branch->client->substreet->district
                                    ? $order->branch->client->substreet->district->name_uz
                                    : 'N/A' }}
                                {{ $order->branch->client->substreet && 
                                $order->branch->client->substreet->district && 
                                $order->branch->client->substreet->district->street
                                    ? $order->branch->client->substreet->district->street->name
                                    : 'N/A' }}
                                {{ $order->branch->client->substreet 
                                    ? $order->branch->client->substreet->name 
                                    : 'N/A' }}</td>
                        </tr>
                    @else
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{{$order->branch->client->company->oked ?? ''}}<</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{{$order->branch->client->company->bank->code ?? ''}}</td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td>{{$order->branch->client->stir ?? ''}}</td>
                    </tr>
