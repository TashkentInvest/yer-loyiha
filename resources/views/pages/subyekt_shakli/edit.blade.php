...
<div class="row">
    <div class="col-8 offset-2">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('subyektShakliUpdate', $subyektShakli->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 mb-2">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ old('name') ?? $subyektShakli->name }}" placeholder="Название" required>
                            </div>
                            <div class="col-12 col-lg-6 mb-2">
                                <label class="col-form-label">@lang('global.name_as') ру</label>

                                <input type="text" name="name_ru" class="form-control" 
                                value="{{ old('name_ru',  $subyektShakli->name_ru ?? '') }}" placeholder="Название " required>
                            </div>

                            <div class="col-12 col-lg-6 mb-2">
                                <label class="col-form-label">Толиқ @lang('global.name_as') уз</label>
                                <input type="text" name="description" class="form-control" value="{{ old('description') ?? $subyektShakli->description }}" placeholder="Название" required>
                            </div>
                            <div class="col-12 col-lg-6 mb-2">
                                <label class="col-form-label">Толиқ @lang('global.name_as') ру</label>

                                <input type="text" name="description_ru" class="form-control" 
                                value="{{ old('description',  $subyektShakli->description_ru ?? '') }}" placeholder="Название " required>
                            </div>
                            {{--  --}}
                            ...
                            <div class="col-12 col-lg-6 mb-2">
                                ...
                                value="{{ old('code', $subyektShakli->code ?? '') }}" placeholder="Название " required>
                            </div>
