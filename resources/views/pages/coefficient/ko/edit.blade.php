...
<div class="row">
    <div class="col-8 offset-2">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('koUpdate', $ko->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="row">
                                <div class="col-12 col-lg-6 mb-2">
                                    ...
                                    value="{{ old('name', $ko->name) }}" placeholder="Название" required>
                                </div>

                                <div class="col-12 col-lg-6 mb-2">
                                    <label>Koeffitsiyent  </label>
                                    <input type="text" name="coefficient" class="form-control" 
                                    value="{{ old('coefficient', $ko->coefficient) }}" placeholder="Koeffitsiyent" required>
                                </div>
                        </div>
                    </div>
                    <div class="form-group ">
